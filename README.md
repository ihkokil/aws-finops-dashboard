...
flowchart TD
    ...
    CE & CW & EC2 & RDS & ELB & S3 -->|AWS SDK v2 Read-Only| Collectors
    Collectors --> Runner
    Runner --> Exporter
...
## 📊 Summary & Resume Highlight

**Resume Bullet:**
> "Built an AWS FinOps cost optimization tool in Go that identifies idle and oversized resources (EC2, RDS, EBS, NAT Gateways, load balancers) via Cost Explorer and CloudWatch APIs, exposing Prometheus metrics for Grafana dashboards, generating daily executive Markdown reports, and auto-creating GitHub Issues for critical waste findings — backed by read-only IAM with explicit Deny rules and OIDC-authenticated daily CI runs."

**Skills Tagged:**
AWS Cost Explorer · FinOps · Cloud Cost Optimization · Go · Prometheus · Grafana · AWS · Terraform · GitHub Actions · CloudWatch · IAM · DevOps · Cloud Governance
<!-- AWS FinOps Dashboard v1.0.0 -->
